...
class pascal_voc_dataset_train():
    ...
    def __init__(self,name_list_file,img_dir, mask_dir,transform=None):
        """
        Args:
            ...
            transform (callable, optional): Optional transform to be applied
                on a sample.
        """
        self.names = open(name_list_file,'r').read().split('\n')
        self.img_dir = img_dir
        self.mask_dir = mask_dir
        self.transform = transform
        self.img_names = [n+'.jpg' for n in self.names]
        self.label_names = [n+'.png' for n in self.names]
    ...
    def __getitem__(self, idx):
        ...
        image, label = self._transform(image,depth,label)
...
class pascal_voc_dataset_val():
    ...
    def __getitem__(self, idx):
        ...
        if self.transform:
            ...
            label = skimage.transform.resize(label, (640, 480), order=0,
