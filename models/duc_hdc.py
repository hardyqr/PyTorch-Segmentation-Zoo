...
# modified from GitHub public implementation
...
if __name__ == "__main__":
    model1 = ResNetDUC(13).cuda()
    model2 = ResNetDUCHDC(13).cuda()
    #x = Variable(torch.FloatTensor(np.random.random((1, 3, 384, 384)))).cuda()
    x_depth = Variable(torch.FloatTensor(np.random.random((1, 4, 384, 384)))).cuda()
    #out1 = model1(x)
    out2 = model2(x_depth)
